  ...
  return (
    <section className="   p-4 sm:p-10 md:p-20 bg-[#dbc3ab]">
      <div className=" w-full h-full flex flex-col md:flex-row items-center gap-12">
        ...
        {/* Text Section */}
        <div className="w-full text-center md:text-left  py-10 md:py-20 rounded-xl flex gap-2  md:gap-6  justify-evenly items-center border border-white border-[2px]">
