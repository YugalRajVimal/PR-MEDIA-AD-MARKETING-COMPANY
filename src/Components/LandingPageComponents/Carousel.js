...
const Carousel = () => {
    ...
    return (
        <div className="relative bg-gray-100 h-[80vh] w-full mx-auto overflow-hidden px-4 sm:px-10 py-8">
            ...
            <button
                onClick={prevSlide}
                className="absolute left-3 sm:left-5 top-1/2 transform -translate-y-1/2 bg-black text-white p-2 sm:p-3 rounded-full shadow-lg hover:bg-gray-800 transition"
            >
                ◀
            </button>
            <button
                onClick={nextSlide}
                className="absolute right-3 sm:right-5 top-1/2 transform -translate-y-1/2 bg-black text-white p-2 sm:p-3 rounded-full shadow-lg hover:bg-gray-800 transition"
            >
                ▶
            </button>
            ...
            <div
                ...
                bg-white/20 backdrop-blur-md border border-white/40 shadow-lg text-white 
