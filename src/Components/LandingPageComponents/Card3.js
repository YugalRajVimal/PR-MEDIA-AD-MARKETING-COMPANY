...
const Card3 = () => {
  return (
    <div className="w-full p-4 pt-10 flex justify-center items-center">
      <div className="relative h-28 max-w-[500px] text-black flex justify-center items-center font-bold w-full border border-zinc-700 bg-[#dbc3ab] border-[2px]  rounded-t-xl rounded-l-xl p-4  md:p-6 mx-auto">
        ...
        <div class="absolute -right-[11px] -bottom-2 w-0 h-0 border-l-[20px] rotate-[27deg] border-l-transparent border-r-[20px] border-r-transparent border-b-[40px] border-b-[#dbc3ab] "></div>
