        ...
        {items.map((item, index) => (
          ...
          >
            <div className="sticky top-[15%] h-52 w-full max-w-[500px] p-2">
              <div className="relative h-full text-black flex justify-center items-center font-bold w-full border border-zinc-700 bg-[#dbc3ab] border-[2px] rounded-xl p-4  md:p-6">
