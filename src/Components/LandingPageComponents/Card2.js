...
const Card2 = () => {
  return (
    <section className="  px-4 sm:px-10 md:px-20  ">
      <div className=" mx-auto max-w-[670px]  flex flex-col md:flex-row items-center gap-4 ">
        {/* Text Section */}
        <div className="relative w-full text-center bg-[#3B2E22] md:text-left m-4 py-12 px-4 md:px-2 rounded-xl flex justify-evenly items-center shadow-[0_10px_30px_rgba(0,0,0,0.7)]">
          <p className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-400 drop-shadow-md shadow-yellow-400">
