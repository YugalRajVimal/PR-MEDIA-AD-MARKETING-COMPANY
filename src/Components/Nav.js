...
//         } absolute top-full left-0 w-full bg-[#291f12] shadow-md md:flex md:static md:w-auto md:bg-transparent md:shadow-none gap-6 z-40`}
//       >
...
//         scrollPosition > 0 ? "text-[#FFD700]" : "text-white"
//       }`}
//     >
//       <div
//         ref={logoRef}
...
//     <nav
//       className={`h-[70px]  px-6 py-2 flex justify-between items-center gap-4 fixed top-0 left-0 w-full z-20 backdrop-blur-md transition-colors duration-300 ${
//         scrollPosition === 0 || isAtBottom ? "text-white" : "text-[#FFD700]"
//       }`}
//     >
//       <div
//         ref={logoRef}
