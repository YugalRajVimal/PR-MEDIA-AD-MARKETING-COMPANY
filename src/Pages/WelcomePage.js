...
const WelcomePage = () => {
  return (
    <div className="bg-[#dbc3ab] md:bg-[#f7dbb6] h-screen w-screen">
      <div className="relative backdrop-blur-sm z-[30] h-full flex flex-col justify-center items-center">
        ...
        <p className="text-center text-2xl md:text-4xl  font-medio font-bold text-[#3B2E22] mt-10 mb-10">
          Hi Author, Welcome to The PR Media!
        </p>
        ...
        <a
          ...
          className="flex items-center mx-auto w-fit justify-center  gap-2 bg-[#25D366] text-white py-2 px-4 rounded-full font-semibold hover:bg-[#1DA851] transition-colors duration-200 cursor-pointer"
        >
